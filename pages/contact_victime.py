"""
Page "Contacter une association" – Formulaire de déclaration pour victimes/témoins VBG.
"""
...
def layout():
    return html.Div([
        ...
        html.Div(className="hero", children=[
            html.Div(style={"fontSize": "2.4rem", "marginBottom": "8px"}, children="🤝"),
            html.H1("Déclarer un incident"),
            html.P(
                "Si vous êtes victime ou témoin de violences basées sur le genre (VBG) en Guinée, "
                "vous pouvez utiliser ce formulaire pour déclarer l'incident.",
        ...
        html.Div(className="form-section", children=[
            ...
            html.Div(className="form-card", children=[
                html.Div(className="form-section-header", children=[
                    html.Span("01", className="section-number"),
                    html.Div([
                        html.H4("Informations personnelles", className="section-title"),
                        html.P("Renseignez vos informations de base. Ces données sont confidentielles.",
                ...
                dbc.Row([
                    dbc.Col([
                        html.Label("Vous déclarez en tant que *", className="filter-label"),
                        dcc.Dropdown(
                            id="cv-declarant",
                            options=[
                                {"label": "👤  Victime directe", "value": "victime"},
                                {"label": "👁  Témoin", "value": "temoin"},
                                {"label": "👨‍👩‍👧  Membre de la famille", "value": "famille"},
                                {"label": "🏥  Professionnel de santé / Social", "value": "professionnel"},
                            ],
                            placeholder="Sélectionner…",
                        ),
                    ], md=6),
                    dbc.Col([
                        html.Label("Souhaitez-vous rester anonyme ?", className="filter-label"),
                        dcc.Dropdown(
                            id="cv-anonyme",
                            options=[
                                {"label": "Oui, je préfère rester anonyme", "value": "oui"},
                                {"label": "Non, je consens à être contacté(e)", "value": "non"},
                            ],
                            placeholder="Choisir…",
                            value="oui",
                        ),
            ...
            html.Div(className="form-card", children=[
                html.Div(className="form-section-header", children=[
                    ...
                    html.Div([
                        html.H4("Localisation de l'incident", className="section-title"),
                        html.P("Où l'incident s'est-il produit ?", className="section-subtitle"),
                    ]),
                ]),
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        html.Label("Quartier / Village", className="filter-label"),
                        dbc.Input(id="cv-quartier", placeholder="Ex : Ratoma centre",
                ...
                dbc.Row([
                    dbc.Col([
                        html.Label("Lieu de l'incident *", className="filter-label"),
                        dcc.Dropdown(
                            id="cv-lieu",
                            options=[{"label": l, "value": l} for l in LIEUX_INCIDENT],
                            placeholder="Où cela s'est-il passé ?",
                        ),
                    ], md=6),
                    dbc.Col([
                        html.Label("Date approximative de l'incident *", className="filter-label"),
                        dbc.Input(id="cv-date", type="date", max=str(date.today()),
                                  className="form-control"),
                    ], md=6),
                ], className="g-3"),
            ]),
            ...
            # ── Section 3 : Contexte de la violence ───────────────
            html.Div(className="form-card", children=[
                html.Div(className="form-section-header", children=[
                    html.Span("03", className="section-number"),
                    html.Div([
                        html.H4("Contexte de la violence", className="section-title"),
                        html.P("Ces informations nous permettent de mieux orienter l'aide.",
                               className="section-subtitle"),
                    ]),
                ]),
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        html.Label("Relation avec l'auteur présumé", className="filter-label"),
                        dcc.Dropdown(
                            id="cv-relation",
                            options=[{"label": r, "value": r} for r in RELATIONS_AUTEUR],
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        dbc.Input(id="cv-age", type="number", min=0, max=120,
                                  placeholder="Âge en années", className="form-control"),
                    ], md=4),
                    dbc.Col([
                    ...
                    dbc.Col([
                        html.Label("L'incident a-t-il été signalé ?", className="filter-label"),
                        dcc.Dropdown(
                            id="cv-signale",
                            options=[
                                {"label": "Non, c'est la première déclaration", "value": "non"},
                                {"label": "Oui, à la police / gendarmerie",     "value": "police"},
                                {"label": "Oui, à une association locale",      "value": "asso"},
                                {"label": "Oui, à un établissement de santé",   "value": "sante"},
                            ],
            ...
            html.Div(className="form-card", children=[
                html.Div(className="form-section-header", children=[
                    ...
                    html.Div([
                        html.H4("Détails et besoins", className="section-title"),
                        html.P("Ces détails nous permettront de vous orienter vers le soutien le plus adapté.",
                               className="section-subtitle"),
                    ]),
                ]),

                html.Label("Décrivez brièvement la situation (facultatif)", className="filter-label"),
                dbc.Textarea(
                    id="cv-description",
                    placeholder=(
                ...
                html.Label("De quel(s) type(s) de soutien avez-vous besoin ? *",
                           className="filter-label"),
                dcc.Checklist(
                    id="cv-besoins",
                    options=[{"label": f"  {b}", "value": b} for b in BESOINS],
                    inputStyle={"marginRight": "8px", "accentColor": "#8E44AD"},
                ...
                html.Label("Urgence de la situation", className="filter-label"),
                dcc.RadioItems(
                    id="cv-urgence",
                    options=[
                        {"label": "  🟢  Pas d'urgence immédiate", "value": "faible"},
                        {"label": "  🟡  Besoin d'aide dans les prochains jours", "value": "moyenne"},
                        {"label": "  🔴  Situation d'urgence – besoin d'aide immédiate", "value": "haute"},
                    ],
                    inputStyle={"marginRight": "8px", "accentColor": "#8E44AD"},
                    labelStyle={"display": "block", "padding": "7px 0",
                                "fontSize": "0.95rem", "cursor": "pointer"},
                ),
            ]),
            ...
            html.Div(className="form-card", children=[
                dcc.Checklist(
                    ...
                    inputStyle={"marginRight": "10px", "accentColor": "#4A235A",
                                "width": "16px", "height": "16px"},
                    labelStyle={"fontSize": "0.9rem", "color": "#444", "lineHeight": "1.5"},
                ),
                ...
                dbc.Button(
                    [html.Span("Envoyer ma déclaration", style={"marginLeft": "6px"})],
                    id="cv-btn-submit",
                    n_clicks=0,
                ...
                # Numéro d'urgence
                html.Div(
                    style={"marginTop": "24px", "padding": "14px 18px",
                           "background": "#FEF9E7", "borderRadius": "8px",
                           "borderLeft": "4px solid #F39C12"},
                    children=[
                        html.Strong("⚠️  En cas de danger immédiat :"),
                        html.Span("  appelez le "),
                        html.Strong("116", style={"fontSize": "1.1rem", "color": "#C0392B"}),
                        html.Span(" (numéro national VBG) ou le "),
                        html.Strong("117", style={"fontSize": "1.1rem", "color": "#C0392B"}),
...
def toggle_identity(anonyme):
    if anonyme == "non":
        return dbc.Row([
            dbc.Col([
                ...
                dbc.Input(id="cv-prenom", placeholder="Votre prénom",
                          className="form-control"),
            ], md=4),
            dbc.Col([
                html.Label("Nom de famille", className="filter-label"),
                dbc.Input(id="cv-nom", placeholder="Votre nom",
                          className="form-control"),
            ], md=4),
            dbc.Col([
                html.Label("Contact (téléphone ou email)", className="filter-label"),
                dbc.Input(id="cv-contact",
    ...
    return html.P(
        ...
        style={"color": "#1E8449", "fontSize": "0.9rem",
...
def submit_declaration(n_clicks, declarant, anonyme, region, prefecture,
                       lieu, date_str, type_v, besoins, urgence, consentement):
    errors = []
    if not declarant:
    ...
    # Ici : enregistrement en base ou envoi par email
    # create_victim_contact(db, {...})
    ...
    success = dbc.Alert([
        ...
        html.P("Merci pour votre courage. Votre déclaration contribue à la protection des victimes.",
               style={"marginTop": "8px", "opacity": 0.85, "fontSize": "0.9rem"}),
    ], color="success", className="alert alert-success")

    # Réinitialise le formulaire
    return success, None, "oui", None, None, None, None, None, None, None, None, None, None, None, None, None, []